				...
				>
					...
					>
						...
						>
							...
							<div style={{ display: 'flex', justifyContent: 'center', marginBottom: '30px', color: 'white' }}>
								Choose account type
							</div>

							<div className="card-container">
								<div className="card">
									<img src={workerImg} alt="Worker" className="card-image" />
									<div className="card-text">Worker</div>
								</div>

								<div className="card">
									<img src={clientImg} alt="Client" className="card-image" />
