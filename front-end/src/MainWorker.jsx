		...
		<div className="w-full">
			...
			<div className="flex justify-evenly items-center bg-gradient-to-r from-[#171717] to-[#444444] w-full">
				...
				<div className="flex gap-[90px] font-mono text-[1rem] italic ">
					<div className="nav-item cursor-pointer" onClick={() => setShowIto('home')}>HOME</div>
					<div className="nav-item cursor-pointer">BROWSE</div>
					<div className="nav-item cursor-pointer" onClick={() => setShowIto('profile')}>PROFILE</div>
